    ...
    function SnowballProgram() {
        ...
        return {
            ...
            f_a: function (
                ...
                var w;
                while (true) {
                    var k = i + ((j - i) >> 1), diff = 0, common = common_i < common_j ? common_i : common_j;
                    w = v[k];
            ...
            f_a_b: function (
                ...
                var i = 0, j = v_size, c = this.c, lb = this.lb, common_i = 0, common_j = 0,
            ...
            r_s: function (
                ...
                var adjustment = s.length - (c_ket - c_bra), left = current.substring(0, c_bra),
