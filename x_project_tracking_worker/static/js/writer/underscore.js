...
(function() {
  ...
  _.each("Boolean Number String Function Array Date RegExp Object".split(" "), function (
      name,
      i
  ) {
  ...
  _.when = function (subordinate) {
        ...
        var i = 0,
            resolveValues = ( _.type(subordinate) === 'array' && arguments.length === 1 ) ? subordinate : slice.call(arguments),
