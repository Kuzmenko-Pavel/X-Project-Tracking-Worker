                      ...
                      , b = function() {
                        ...
                        i(b, [{
                            ...
                            value: function(a, b) {
                                ...
                                if (c == null)
                                    throw new Error("Configuration for " + b + " on " + a + " not found");
                                return c
                            }
                        }]);
                        return b
                ...
                (function() {
                    ...
                    g = {
                        ...
                        optIn: function(a, b) {
                            ...
                            v(b) && (this.optIns.optIn(a, b, d),
                            m([b].concat(j(t[b] || [])), function(a) {
                                u[a] && m(u[a], function(a) {
                        ...
                        consent: function(a) {
                            a == "revoke" ? this.locks.lockConsent() : a == "grant" ? this.locks.unlockConsent() : r({
                        ...
                        fire: function(a) {
                            ...
                            if (a.userData && n(a.userData).length > 0 && !this.fbq.loadPlugin("identity")) {
                                this.enqueue("fire", a);
                                return this
                            }
                        ...
                        getDefaultSendData: function(a, b) {
                            ...
                            c && (c.userData && (a.userData = c.userData),
                            c.agent ? a.set = {
                                agent: c.agent
                            } : this.fbq.agent && (a.set = {
                        ...
                        loadConfig: function(a) {
                            if (this.fbq.disableConfigLoading || Object.prototype.hasOwnProperty.call(this.configsLoaded, a))
                                return;
                            this.locks.lockConfig(a);
                            (!this.fbq.pendingConfigs || p(this.fbq.pendingConfigs, function(b) {
                                return b === a
                            }) == !1) && w(a, this.VERSION, this.RELEASE_SEGMENT)
                        },
                    ...
                    function u(a, e) {
                        try {
                            ...
                            if (i && f < .01 || h === "canary") {
                                ...
                                b(a, Error) && (f.append("f", a.fileName),
        ...
        f.ensureModuleRegistered("SignalsFBEventsMobileAppBridge", function() {
            return function(g, i, j, k) {
                ...
                (function() {
                    ...
                    function m(a) {
                        if (Object.prototype.hasOwnProperty.call(k, [0]) && Object.prototype.hasOwnProperty.call(k[a[0]], a[1]))
                            return !0;
                        var b = g[l(a)];
                ...
                (function() {
                    ...
                    function b(c) {
                        ...
                        for (var e = 0; e < d.length; e++) {
                            ...
                            i = i[1];
                            if (h < 0 || h > 1)
                                throw new Error("passRate should be between 0 and 1 in " + f.name);
                            if (b >= j && b < i) {
                                j = a() < h;
                                return {
                                    name: f.name,
                                    isInExperimentGroup: j,
                                    code: f.code + (j ? "1" : "0")
                                }
                            }
                        }
            ...
            return function(f, g, i, j) {
                ...
                (function() {
                    ...
                    e.prototype.appendHash = function(b, c) {
                        for (var d in b)
                            Object.prototype.hasOwnProperty.call(b, d) && this._append(encodeURIComponent(d), b[d], a, c);
                        return this
                    }
                    ;
            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function t(a, c, f, g, h) {
                        ...
                        var i = !1;
                        if (n.EXPERIMENT) {
                            var k = n.EXPERIMENT.get("button_click_send_beacon");
                            k = k && k.isInExperimentGroup;
                            i = c === "SubscribedButtonClick" && k;
                            h.append("exp", "button_click_send_beacon")
                        }
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function() {
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    function Q(b) {
                        try {
                            ...
                            if (b.slice(0, 6) === "report") {
                                var e = b.slice(6);
                                e === "CustomEvent" ? (e = (c[1] || {}).event || e,
                                c = ["trackCustom", e].concat(c.slice(1))) : c = ["track", e].concat(c.slice(1))
                            }
                            b = c.shift();
                            switch (b) {
                            case "addPixelId":
                    ...
                    function R(b) {
                        for (var d = arguments.length, e = Array(d > 1 ? d - 1 : 0), f = 1; f < d; f++)
                            e[f - 1] = arguments[f];
                        switch (b) {
                        case "endpoint":
                            var g = e[0];
                        ...
                        case "experiments":
                            var n = e[0];
                            P.setExperiments(n);
                            c.CONFIG.EXPERIMENT = P.getExperiments();
                            break;
                        case "mobileBridge":
                            var p = e[0]
                              , r = e[1];
                    ...
                    function S(a, b, c) {
                        ...
                        if (H.call(M, a)) {
                            b && A(M[a].userData) ? (M[a].userData = b,
                            Z("identity")) : D({
                    ...
                    function ga(a, b, c) {
                        ...
                        d.error && D(d.error);
                        if (d.warnings)
                            for (var e = 0; e < d.warnings.length; e++)
                                D(d.warnings[e]);
                        if (H.call(M, c)) {
                    ...
                    function U(a, b) {
                        for (var c = 0, d = L.length; c < d; c++) {
                            var e = L[c];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(O, a) && O[a].has(e.id))
                                continue;
                            X(e, a, b);
                    ...
                    function Z(b) {
                        ...
                        b = o.CONFIG.CDN_BASE_URL + "signals/plugins/" + b + ".js?v=" + a.version;
                        if (!F[c]) {
                            E.lockPlugin(c);
                            o.loadJSFile(b);
                            return !0
                    ...
                    function $(b, c) {
                        if (Object.prototype.hasOwnProperty.call(F, b))
                            return;
                        H.call(c, "__fbEventsPlugin") && c.__fbEventsPlugin === 1 && (F[b] = c,
                        F[b].plugin(a, P, t),
                        w("pluginLoaded", b));
                        E.releasePlugin(b)
                    }
