            ...
            return function (
                ...
                (function () {
                    ...
                    var b = f.getFbeventsModules("SignalsFBEventsOptTrackingOptions"),
                        ...
                        d = f.getFbeventsModules("SignalsFBEventsProxyState"), g = !1;
                    ...
                    c = new c(function (
                        ...
                        a.on("getCustomParameters", function (f) {
                            if (f == null) return {};
                            var g = c.optIns, k = j(g.isOptedOut(f.id, "AutomaticSetup"), b.AUTO_CONFIG_OPT_OUT);
                            g = j(g.isOptedIn(f.id, "AutomaticSetup"), b.AUTO_CONFIG);
                            var l = j(a.disableConfigLoading !== !0, b.CONFIG_LOADING),
                                m = j(h(), b.SUPPORTS_DEFINE_PROPERTY), n = j(i(), b.SUPPORTS_SEND_BEACON);
    ...
    (function () {
                        ...
                        i(b, [
                            ...
                            },
                            {
                                ...
                                value: function (
                                    ...
                                    if (c == null) throw new Error("Configuration for " + b + " on " + a + " not found");
                                    return c
                                }
                            }
                        ]);
            ...
            return function (
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsEventValidation"),
                        ...
                        i = f.getFbeventsModules("SignalsFBEventsQE"), k = f.getFbeventsModules("SignalsFBEventsUtils"),
                        l = f.getFbeventsModules("SignalsPixelEndpoint"),
                        m = f.getFbeventsModules("SignalsFBEventsConfigStore"), n = k.each, o = k.keys, p = k.map,
                        q = k.some, r = c.logError, s = c.logUserError, t = {
                            AutomaticMatching: !0,
                            Dwell: !0,
                            FPCookie: !0,
                            Interaction: !0,
                    ...
                    function x(
                        ...
                        var d = g.get(), e = "https://connect.facebook.net";
                        typeof d.baseURL === "string" && d.baseURL !== null && (e = d.baseURL);
                        e = e + "/signals/config/" + a + "?v=" + b + "&r=" + c;
                        a = h.createElement("script");
                        a.src = e;
                        a.async = !0;
                        d.scriptElement && d.scriptElement.parentNode ? d.scriptElement.parentNode.insertBefore(a, d.scriptElement) : h.body && h.body.firstChild && h.body.insertBefore(a, h.body.firstChild)
                    }
                    ...
                    c = {
                        ...
                        optIn: function (
                            ...
                            var c = this, d = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
                            if (typeof b !== "string" || !w(b)) throw new Error('Invalid Argument: "' + b + '" is not a valid opt-in feature');
                            w(b) && (this.optIns.optIn(a, b, d), n([b].concat(j(u[b] || [])), function (a) {
                                v[a] && n(v[a], function (a) {
                        ...
                        consent: function (a) {
                            a == "revoke" ? this.locks.lockConsent() : a == "grant" ? this.locks.unlockConsent() : s({
                        ...
                        fire: function (a) {
                            ...
                            if (a.userData && o(a.userData).length > 0 && !this.fbq.loadPlugin("identity")) {
                                this.enqueue("fire", a);
                                return this
                            }
                            var c = this.fbq.getEventCustomParameters(this.getPixel(a.pixelId)), d = a.customParameters;
                            d && n(o(d), function (a) {
                                if (c.containsKey(a)) throw new Error("Custom parameter " + a + " already specified."); else c.append(a, d[a])
                            });
                        ...
                        getDefaultSendData: function (
                            ...
                            c && (c.userData && (a.userData = c.userData), c.agent ? a.set = {agent: c.agent} : this.fbq.agent && (a.set = {agent: this.fbq.agent}));
                            return a
                        },
                        ...
                        ensurePixel: function (a) {
                            if (!Object.prototype.hasOwnProperty.call(this.pixelsByID, a)) throw new Error('Pixel "' + a + '" not found')
                        },
                        getPixel: function (a) {
                            this.ensurePixel(a);
                        ...
                        loadConfig: function (a) {
                            if (this.fbq.disableConfigLoading || Object.prototype.hasOwnProperty.call(this.configsLoaded, a)) return;
                            this.locks.lockConfig(a);
                            (!this.fbq.pendingConfigs || q(this.fbq.pendingConfigs, function (b) {
                                return b === a
                            }) == !1) && x(a, this.VERSION, this.RELEASE_SEGMENT)
                        },
        ...
        f.ensureModuleRegistered("SignalsFBEventsLogging", function () {
            return function (
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsUtils"), b = a.isInstanceOf, c = a.sendPOST,
                        d = f.getFbeventsModules("SignalsParamList"), e = !1;
                    ...
                    a = "console";
                    var l = "warn", m = g[a] && g[a][l] ? g[a][l].bind(g[a]) : function () {
                    }, n = !1;
                    ...
                    var q = "Facebook Pixel Error", r = g.postMessage ? g.postMessage.bind(g) : function () {
                    }, s = {};
                    ...
                    function t(a) {
                        switch (a.type) {
                            ...
                            case"NONSTANDARD_EVENT":
                                c = a.eventName;
                                return "You are sending a non-standard event '" + c + "'. The preferred way to send these events is using trackCustom. See 'https://www.facebookmarketingdevelopers.com/pixels/up#sec-custom' for more information.";
                    ...
                    function v(a) {
                        ...
                        if (!Object.prototype.hasOwnProperty.call(s, b)) s[b] = !0; else return;
                        b = t(a);
                        p(b);
                        r({
                            action: "FB_LOG",
        ...
        f.ensureModuleRegistered("SignalsFBEventsOptIn", function () {
            return function (
                ...
                (function () {
                    ...
                    i.prototype.optIn = function (
                        a,
                        c
                    ) {
                        var d = this, e = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !1;
                    ...
                    i.prototype.isOptedIn = function (
                        a,
                        b
                    ) {
                        return this._opts[b] && this._opts[b][a] === !0
                    };
                    i.prototype.isOptedOut = function (
                        a,
                        b
                    ) {
                    ...
                    i.prototype.listPixelIds = function (a) {
                        var b = this;
                        return this._opts[a] ? c(d(this._opts[a]), function (c) {
                            return b._opts[a][c]
                        }) : []
                    };
                    e.exports = i
        ...
        f.ensureModuleRegistered("SignalsFBEventsPluginPath", function () {
            return function (
                ...
                (function () {
                    ...
                    function b() {
                        var b = null, c = null, d = g.getElementsByTagName("script");
                        for (var e = 0; e < d.length && !b; e++) if (d[e] && d[e].src) {
                ...
                (function () {
                    ...
                    function b(c) {
                        ...
                        for (var d = 0; d < c.length; d++) {
                            var e = c[d], f = e.passRate, h = g(e.range, 2), i = h[0];
                            h = h[1];
        ...
        f.ensureModuleRegistered("SignalsFBEventsTelemetry", function () {
            return function (
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsLogging"),
                        b = f.getFbeventsModules("SignalsFBEventsUtils"), c = b.sendPOST,
        ...
        f.ensureModuleRegistered("SignalsFBEventsUtils", function () {
            return function (
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsProxyState"), b = Object.prototype.toString,
                    ...
                    var l = Number.isInteger || function (a) {
                    ...
                    function m(
                        ...
                        b = c ? "on" + b : b;
                        var e = c ? a.attachEvent : a.addEventListener, f = c ? a.detachEvent : a.removeEventListener,
                            g = function c() {
                                f && f.call(a, b, c, !1), d()
                            };
                        e && e.call(a, b, g, !1)
                    ...
                    function z(
                        ...
                        var e = "fb" + Math.random().toString().replace(".", ""), f = i.createElement("form");
                        f.method = "post";
                        f.action = x(c, d);
                        f.target = e;
        ...
        f.ensureModuleRegistered("SignalsParamList", function () {
            return function (
                ...
                (function () {
                    ...
                    function c(a) {
                        if (typeof JSON === "undefined" || JSON === null || !JSON.stringify) return Object.prototype.toString.call(a); else return JSON.stringify(a)
                    }
                    ...
                    e.prototype.appendHash = function (
                        b,
                        c
                    ) {
                    ...
                    e.prototype._translateValue = function (
                        a,
                        b,
                        c
                    ) {
                    ...
                    e.prototype._appendPrimitive = function (
                        a,
                        b,
                        c
                    ) {
                    ...
                    e.prototype._appendObject = function (
                        a,
                        c,
                        d
                    ) {
        ...
        f.ensureModuleRegistered("SignalsPixelEndpoint", function () {
            return function (
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsEvents"), b = f.getFbeventsModules("SignalsFBEventsTelemetry"),
                        c = f.getFbeventsModules("SignalsFBEventsUtils"), d = c.sendBeacon, e = c.sendGET,
                        j = c.sendPOST, l = f.getFbeventsModules("SignalsParamList"), m = a.trigger, n = {
        ...
        f.ensureModuleRegistered("SignalsFBEvents", function () {
            return function (
                ...
                (function () {
                    ...
                    var b = a.getFbeventsModules("SignalsParamList"), c = a.getFbeventsModules("SignalsPixelEndpoint"),
                        d = a.getFbeventsModules("SignalsEvents"), e = a.getFbeventsModules("SignalsFBEventsUtils"),
                        ...
                        t = a.getFbeventsModules("SignalsFBEventsConfigStore"), u = d.on, v = d.once, w = d.trigger,
                        x = e.each;
                    d = e.FBSet;
                    var y = e.isArray, z = e.isInteger, A = e.isEmptyObject, B = e.isNumber, C = e.keys,
                        aa = l.logError, D = l.logUserError, E = p.global;
                    ...
                    var F = {}, G = -1, da = Array.prototype.slice, H = Object.prototype.hasOwnProperty, I = i.href,
                        J = !1, K = !1, L = [], M = {}, N;
                    h.referrer;
                    var O = {
                        PageView: new d(),
                        PixelInitialized: new d()
                    }, P = new n(a, M);
                    ...
                    function R(b) {
                        ...
                        switch (b) {
                            ...
                            case"releaseSegment":
                                var h = e[0];
                                if (typeof h !== "string") throw new Error("releaseSegment value must be a string");
                                a._releaseSegment = h;
                                break;
                            case"proxy":
                                var i = e[0];
                                if (c.CONFIG.PROXY_ENDPOINT) throw new Error("proxy has already been set");
                                if (typeof i !== "string") throw new Error("endpoint value must be a string");
                                c.CONFIG.PROXY_ENDPOINT = i;
                                break;
                            case"autoConfig":
                                var j = e[0], k = e[1], l = j === !0 || j === "true" ? "optIn" : "optOut";
                                if (typeof k !== "string") throw new Error("Invalid pixelID supplied to set autoConfig.");
                                P.callMethod([
                                    l,
                                    k,
                                    "AutomaticSetup"
                            ...
                            case"mobileBridge":
                                var n = e[0], o = e[1];
                                if (typeof n !== "string") throw new Error("Invalid pixelID supplied to set call.");
                                if (typeof o !== "string") throw new Error("Invalid appID supplied to set call.");
                                q.registerBridge([
                                    n,
                                    o
                                ]);
                            ...
                            default:
                                var p = e[0], r = e[1];
                                if (typeof b !== "string") throw new Error("The metadata setting provided in the 'set' call is invalid.");
                                if (typeof p !== "string") throw new Error("The metadata value must be a string.");
                                if (typeof r !== "string") throw new Error("Invalid pixelID supplied to set call.");
                                ga(b, p, r);
                                break
                        }
                    }
                    ...
                    function S(
                        ...
                        if (H.call(M, a)) {
                            b && A(M[a].userData) ? (M[a].userData = b, Z("identity")) : D({
                    ...
                    function ga(
                        ...
                        d.error && D(d.error);
                        if (d.warnings) for (var e = 0; e < d.warnings.length; e++) D(d.warnings[e]);
                        if (H.call(M, c)) {
                            for (var e = 0, d = L.length; e < d; e++) if (L[e].id === c) {
                                L[e][a] = b;
                                break
                            }
                        } else D({
                    ...
                    function ha(
                        ...
                        b = b || {}, m.validateEventAndLog(a, b), a === "CustomEvent" && typeof b.event === "string" && (a = b.event), U.call(this, a, b)
                    }
                    ...
                    function U(
                        ...
                        for (var c = 0, d = L.length; c < d; c++) {
                            var e = L[c];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(O, a) && O[a].has(e.id)) continue;
                            X(e, a, b);
                    ...
                    function W(c) {
                        ...
                        x(c, function (a) {
                            return x(C(a), function (b) {
                                if (d.containsKey(b)) throw new Error("Custom parameter " + b + " has already been specified."); else d.append(b, a[b])
                            })
                        });
                        d.append("it", G);
                        return d
                    ...
                    function Z(b) {
                        ...
                        if (d.baseURL && d.scriptElement) {
                            ...
                            if (!F[c]) {
                                ...
                                c.src = b;
                                c.async = !0;
                                d.scriptElement && d.scriptElement.parentNode && d.scriptElement.parentNode.insertBefore(c, d.scriptElement)
                            }
                        }
                        return !1
                    }
                    ...
                    function $(
                        ...
                        H.call(c, "__fbEventsPlugin") && c.__fbEventsPlugin === 1 && (F[b] = c, F[b].plugin(a, P, t), w("pluginLoaded", b));
                        E.releasePlugin(b)
                    }
                    ...
                    function ma() {
                        return {
                            pixelInitializationTime: G,
                            pixels: L
                        }
                    }

                    function na(a) {
                        a.instance = P, a.callMethod = Q, a.loadPlugin = Z, a.registerPlugin = $, a._initHandlers = [], a._initsDone = {}, a.on = u, a.once = v, a.send = V, a.trigger = w, a.getEventCustomParameters = W, a.addInitHandler = la, a.getState = ma, a.init = S, a.set = R
                    }
